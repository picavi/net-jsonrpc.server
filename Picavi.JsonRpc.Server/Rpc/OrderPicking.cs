        ...
        public JsonRpcResponse GetPickList(JsonRpcRequest jsonRpcRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    response = ResponseFactory.BuildError(ErrorCodes.E_InternalError, ErrorMessage.Msg_InternalError, ErrorMessage.Dsc_InternalError, ID);
            ...
            {
                var ID = jsonRpcRequest.Id;
                response = ResponseFactory.BuildError(ErrorCodes.E_InvalidParams, ErrorMessage.Msg_InvalidParams, ErrorMessage.Dsc_InvalidParams, ID);
